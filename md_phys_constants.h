...
const double length_const = 1e-6;
const double mass_const = 1e-14;
const double time_const = 1e-9;
const double volume_const = length_const*length_const*length_const;//1e-18//1e-30
const double force_const = mass_const*length_const/(time_const*time_const);//1e-2//1e-3
const double pressure_const = force_const/(length_const*length_const);//1e+10//1e+17
const double stress_const = force_const/(length_const*length_const);//1e+17
const double velocity_const = length_const/time_const;//1e+3//1e-5
const double energy_const = force_const*length_const;//1e-13
const double density_const = mass_const / volume_const;//1e+7

const double N_a_PhysConst = 6.022045e23;
const double e_q_PhysConst = 1.60217733e-19;   // Кл
const double k_PhysConst = 1.380662e-23/energy_const;// Дж/К
const double _1d_k_PhysConst = 1.0/k_PhysConst;
const double cLight_PhysConst = 299792458.0/length_const;
const double cm_m1_const = 1.0/(2.0*MC_pi*cLight_PhysConst*length_const*time_const*100.0);
const double eV_const = 1.602e-19/energy_const;
const double eV_m_const = 1.782661907e-36/mass_const;
const double aem_const = 1.66053906660e-27/mass_const;
